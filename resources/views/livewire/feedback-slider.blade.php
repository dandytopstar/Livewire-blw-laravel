        ...
        <div class="carousel-item active">
            <div class="d-flex justify-content-between">
                ...
                <div class="clients-item white-shadow-box-radius-10">
                    <div class="clients-inf d-flex">
                        <div class="avatar-box">
                            <img src="{{asset('assets/avatar/avatar-1.jpg')}}" alt="">
                        </div>
                        <div class="author-inf d-flex justify-content-between w-100">
                            <div>
                                <p class="font-grey-16-700 name">{{__('front.feedback_slider_text_author_1')}}</p>
                    ...
                    <div class="clients-comment">
                        <p class="font-grey-color-400">{{__('front.feedback_slider_text_1')}}</p>
                    </div>
                </div>
                ...
                <div class="clients-item white-shadow-box-radius-10">
                    <div class="clients-inf d-flex">
                        <div class="avatar-box">
                            <img src="{{asset('assets/avatar/avatar-2.jpg')}}" alt="">
                        </div>
                        <div class="author-inf d-flex justify-content-between w-100">
                            <div>
                                <p class="font-grey-16-700 name">{{__('front.feedback_slider_text_author_2')}}</p>
                                <div class="star-box d-flex">
                                    <img src="{{asset('assets/icons/star.svg')}}" alt="">
                                    <img src="{{asset('assets/icons/star.svg')}}" alt="">
                                    <img src="{{asset('assets/icons/star.svg')}}" alt="">
                    ...
                    <div class="clients-comment">
                        <p class="font-grey-color-400">{{__('front.feedback_slider_text_2')}}</p>
                    </div>
                </div>
                ...
                <div class="clients-item white-shadow-box-radius-10">
                    <div class="clients-inf d-flex">
                        <div class="avatar-box">
                            <img src="{{asset('assets/avatar/avatar-3.jpg')}}" alt="">
                        </div>
                        <div class="author-inf d-flex justify-content-between w-100">
                            <div>
                                <p class="font-grey-16-700 name">{{__('front.feedback_slider_text_author_3')}}</p>
                                <div class="star-box d-flex">
                                    <img src="{{asset('assets/icons/star.svg')}}" alt="">
                                    <img src="{{asset('assets/icons/star.svg')}}" alt="">
                                    <img src="{{asset('assets/icons/star.svg')}}" alt="">
                    ...
                    <div class="clients-comment">
                        <p class="font-grey-color-400">{{__('front.feedback_slider_text_3')}}</p>
                    </div>
                </div>
...
{{--                    <div class="clients-inf d-flex">--}}
{{--                        <div class="avatar-box">--}}
{{--                            <img src="{{asset('assets/avatar/avatar-4.jpg')}}" alt="">--}}
{{--                        </div>--}}
{{--                        <div class="author-inf d-flex justify-content-between w-100">--}}
{{--                            <div>--}}
{{--                                <p class="font-grey-16-700 name">{{__('front.feedback_slider_text_author_4')}}</p>--}}
{{--                                <div class="star-box d-flex">--}}
{{--                                    <img src="{{asset('assets/icons/star.svg')}}" alt="">--}}
{{--                                    <img src="{{asset('assets/icons/star.svg')}}" alt="">--}}
{{--                                    <img src="{{asset('assets/icons/star.svg')}}" alt="">--}}
...
{{--                    </div>--}}
{{--                    <div class="clients-comment">--}}
{{--                        <p class="font-grey-color-400">{{__('front.feedback_slider_text_4')}}</p>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
