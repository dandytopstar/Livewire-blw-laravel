...
<div class="mt-100 card mx-auto quiz-card shadow-lg p-3 mb-5 bg-body rounded">
    ...
    <div class="container tp-2 border-bottom p-3">
        <div class="row">
            ...
            <div class="col text-center">
                <img src="http://blw-dev.loc/assets/logo/logo-mobile-landing-only.png" alt="" width="60px">
            </div>
    ...
    <div class="card-body">
        <h2 class="card-title text-center question-title mt-40 p-4">{{$currentQuestion['loader']['text']}}</h2>
